...
| 0143 | [A custom connector is a bundle-built HTTP MCP server that holds its own credential](0143-a-custom-connector-is-a-bundle-built-http-mcp-server-that-holds-its-own-credential.md) | Draft |
