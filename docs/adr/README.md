...
| 0133 | [A write connector declares permitted field paths, and the agent composes within them](0133-a-write-connector-declares-permitted-field-paths-and-the-agent-composes-within-them.md) | Draft |
