...
| Channel / ingress | SOFT | 3 (Slack, Discord, email) | C | #7, #19, #27, #38, #1515 | [Channel / ingress](interfaces/channel-ingress/INTERFACE.md) |
...
| CLI output (agent-facing `--json`) | CLEAN | 45 outputs behind one trait | not separately graded | #456 | [CLI output (agent-facing `--json`)](interfaces/cli-output/INTERFACE.md) |
