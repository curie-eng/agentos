...
SCREEN_FOR_COMMAND: dict[str, str | Exempt] = {
    ...
    "cluster observability metrics": OBSERVABILITY,
    "cluster observability run": OBSERVABILITY,
    "cluster observability runs": OBSERVABILITY,
    "local observability metrics": OBSERVABILITY,
    "local observability run": OBSERVABILITY,
    "local observability runs": OBSERVABILITY,
    "cluster eval": EVALS,
    "local eval": EVALS,
    ...
    "skill observability metrics": Exempt.local_machine,
    "skill observability run": Exempt.local_machine,
    "skill observability runs": Exempt.local_machine,
    ...
    "dev e2e-ci-selection": Exempt.source_checkout,
