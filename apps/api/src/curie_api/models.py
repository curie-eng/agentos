...
class Agent(Base):
    ...
    # The agent's channel bindings (ADR-0096, #1459; PLURAL since ADR-0107,
    # migration 0025): an agent may hold more than one, so the API surface is a
...
class AgentChannel(Base):
    ...
    __table_args__ = (
        ...
        # No agent_id uniqueness here (ADR-0107, migration 0025): an agent may
