"""one agent may hold more than one channel binding (ADR-0118, #1459)
...
channel" is superseded in part by ADR-0118: `agent_channels` already models a
...
def downgrade() -> None:
    ...
    if offenders:
        ...
        raise RuntimeError(
            "cannot restore one-binding-per-agent (ADR-0118, #1459): these "
