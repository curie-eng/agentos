...
const AGENT = { id: "a1", name: "deal-desk", channel: { kind: "slack", address: "C0123ABCD" }, channels: [{ kind: "slack", address: "C0123ABCD" }], model: null, created_at: "2026-07-01T00:00:00Z" };
