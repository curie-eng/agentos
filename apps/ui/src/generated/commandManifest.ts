      ...
      "subcommands": [
        ...
        },
        {
          ...
          "args": [
            ...
            {
              "global": false,
              "help": "Not available at this tier: the MCP load probe boots a runner container mounting a bundle DIRECTORY on this machine (`curie_runner.check`), and a deployed bundle exists only as stored files in the platform, with no directory here to mount; run `curie skill info --plugin-dir <dir> --check-mcp` (or `curie skill check`) against the bundle source, then deploy the bundle that probed clean",
              "id": "check_mcp",
              "long": "check-mcp",
              "positional": false,
              "possible_values": [
